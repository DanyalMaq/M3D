...
#     --bf16 True \
#     --output_dir /mym3d/LaMed/output/LaMed-Phi3-4B/focal/ct-mask-adapter-0000 \
#     --num_train_epochs 5 \
...
accelerate launch /mym3d/LaMed/src/train/train.py \
    ...
    --pretrain_vision_model /mym3d/LaMed/pretrained_ViT.bin \
    --bf16 True \
    --output_dir /mym3d/LaMed/output/LaMed-Phi3-4B/focal/ct-mask-finetune-0000 \
    --pretrain_mm_mlp_adapter /mym3d/LaMed/output/LaMed-Phi3-4B/focal/ct-mask-adapter-0000/mm_projector.bin \
    --num_train_epochs 5 \
